-- Fix PL/pgSQL "record s is not assigned yet": after SELECT INTO with zero rows, a bare RECORD
-- is uninitialized; do not read s.id — use FOUND instead. Same pattern for class lookup.
